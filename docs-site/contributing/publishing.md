...
The SDK change is self-contained — no code changes required in the Starter or Test modules.
...
The SDK introduces a new or changed API that the Starter or Test must use. This requires **two releases**.
